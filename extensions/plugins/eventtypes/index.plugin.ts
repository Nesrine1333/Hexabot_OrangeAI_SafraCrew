...
export class JustPlugin extends BaseBlockPlugin<typeof SETTINGS> {
  ...
  async process(
    ...
    const eventTypes = await fetch(
      ...
      {
        headers: {
          Authorization: 'Bearer ' + args.CalendlyToken,
    ...
    console.log(
      'types arrayhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh' +
        context.vars.typesarray,
    );
